...
def parsecsvdata():
    ...
    # open csv data
    with open("/home/student/static/training/Python3Class/graphing/2018summary.csv",\
     "r") as downtime:
...
def main():
    ...
    plt.savefig("/home/student/static/training/Python3Class/graphing/2018summaryv2.png")
    # Save to "~/static"
