...
def main():
    """called at runtime"""
    os.chdir('/home/student/static/training/Python3Class/')   # move into this working directory
    shutil.move('raynor.obj', 'ceph_storage/')  # try moving the file raynor.obj into cypher_storage/ dir
